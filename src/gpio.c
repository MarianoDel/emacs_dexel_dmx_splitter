...
void GPIO_Config (void)
{
    ...
    temp &= 0x3FCC0CFF;    //PA4 output; PA6 - PA7 alternative
    temp |= 0x4020A100;    //PA8 input exti; PA10 alternative; PA15 output
    GPIOA->MODER = temp;
    ...
    temp &= 0x3FFF0CFF;    //PA4 low speed; PA6 - PA7 low speed    
    temp |= 0x00000000;    //PA15 low speed
    GPIOA->OSPEEDR = temp;
    ...
    temp &= 0xFFFFFFF0;    //PB0 PB1 alternative
    temp |= 0x0000000A;
    GPIOB->MODER = temp;
